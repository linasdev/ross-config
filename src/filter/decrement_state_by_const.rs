...
mod tests {
    ...
    fn deserialize_test() {
        ...
        let filter = Box::new(DecrementStateByConstFilter::new(0xabab_abab, Value::U32(0xffff_ffff)));

        assert_eq!(DecrementStateByConstFilter::try_deserialize(&data), Ok(filter));
    }
    ...
    fn deserialize_wrong_size_test() {
        ...
        assert_eq!(DecrementStateByConstFilter::try_deserialize(&data), Err(ConfigSerializerError::WrongSize));
    }
}
